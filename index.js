...
const DEFAULT_STACKTRACE_OFFSET = NODEJS_VERSION && NODEJS_VERSION > 6 ? 2 : 3
...
function traceCaller (pinoInstance, {stackTraceOffset = 0, lineOffset = 0} = {}) {
  ...
  function asJson (...args) {
    ...
    .filter(s => !s.includes('node_modules/pino'))[stackTraceOffset + DEFAULT_STACKTRACE_OFFSET].substr(lineOffset + DEFAULT_LINE_OFFSET)
